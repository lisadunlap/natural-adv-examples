...
def get_net_results():
    ...
    return num_correct / len(nae_loader.dataset), confidence.copy(), correct.copy(), answers


acc, test_confidence, test_correct, answers = get_net_results()
if args.save_results:
    res = pd.DataFrame()
    if args.add:
        res = pd.read_csv(args.save_results)
    res[f"{args.model} answers"] = answers
